...
- (void) enqueueStatement:(TCStatement *)statement
{
    TCStatementCollection *statementQueue = [[TCStatementCollection alloc] init];
    
    [statementQueue addStatement:statement];
}
...
- (void) sendOldestFromQueueWithCompletionBlock:(void(^)())completionBlock
{
//    TCOfflineStatementCollection *statementQueue = [[TCOfflineStatementCollection alloc] init];
...
//    [self sendStatement:statementToSend withCompletionBlock:^{
